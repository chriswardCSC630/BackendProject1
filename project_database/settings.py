...
SECRET_KEY = 'se-3^9jj$xpgpy$0wf)$-nfq29x&*55_m-3(p&=)l9bv(v=nux'
...
MIDDLEWARE = [
    ...
    #'django.middleware.csrf.CsrfViewMiddleware', # commented for security reasons: https://docs.djangoproject.com/en/2.1/ref/csrf/
...
DATABASES = {
    'default': {
        ...
        'USER': 'jghbpnbeujksca',
        'PASSWORD': '1ab46a2b4af891c3374c73fc0d39e0216c9440111c24403ad0a0b90724ea6813',
